      ...
      <div className="mx-auto max-w-screen-xl px-4 pt-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl font-bold text-gray-600 sm:text-4xl">
            Shuffle, Deal, Conquer – Poker Nights at 2A Lorne Avenue!
          </h2>

          <p className="mt-4 text-gray-400 sm:text-xl">
            Eight players sit around the felt-covered table at 2A Lorne Avenue,
            the air thick with anticipation as chips clatter, cards snap, and
            steely gazes lock in a battle of wits and nerve.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex items-center justify-center  text-teal-600">
              ...
              <p className="font-bold text-2xl">PokerNight</p>
            </div>
