...
export function LeaderBoard() {
  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
        <div className="h-32 rounded-lg bg-gray-200">
          ...
          <article className="rounded-lg border border-gray-100 bg-white p-6">
            <div>
              <p className="text-sm text-gray-500">Session Winner</p>
        ...
        <div className="h-32 rounded-lg bg-gray-200">
          ...
          <article className="rounded-lg border border-gray-100 bg-white p-6">
            <div>
              <p className="text-sm text-gray-500">Session Loser</p>
      ...
      <div className="text-2xl font-bold text-blue-600 md:text-5xl text-center pb-4 pt-4">
        Leader Board
      </div>
      <Table>
